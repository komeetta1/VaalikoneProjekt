		...
		for (Kysymykset kysymys : kysymykset) {%>
			...
			<tr>
                    ...
                    <label>5</label><input type="radio" name="vastaus[<%= kysymys.getKysymysId() %>]" value="5" /><small>T‰ysin samaa mielt‰</small><br>
                  	...
                  	<td>
                  	<textarea name="perusteluBox[<%=kysymys.getKysymysId() %>]" cols="50" rows="5" maxlength="100" placeholder="Perustelut vastaukselle (max. 100 merkki‰)">ESIMERKKIVASTAUS</textarea>
                  	</td>
			</tr>
			<tr>
			<td><hr></td>
