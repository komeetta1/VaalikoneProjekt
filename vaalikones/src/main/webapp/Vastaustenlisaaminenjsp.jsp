	...
	<div id="container">
		...
		<form action="/vastaustenLisays" method="GET">
			<select name="vastaaja">
				<% /** Looppi, joka k‰y tietokannasta saadut ehdokkaat lÔøΩpi ja tulostaa ne dropdown-listaan*/
		...
		<%
		/**Looppaa tietokannasta saadut kysymykset lÔøΩpi, ja asettaa ne sopivaan HTML taulukkoon*/
		for (Kysymykset kysymys : kysymykset) {%>
			<%
			// tulostaa kysymykset konsoliin, lÔøΩhinnÔøΩ debuggausta varten
