...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Kysymykset.findAll", query = "SELECT k FROM Kysymykset k"),
...
public class Kysymykset implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return !((this.kysymysId == null && other.kysymysId != null)
				|| (this.kysymysId != null && !this.kysymysId.equals(other.kysymysId)));
	}
